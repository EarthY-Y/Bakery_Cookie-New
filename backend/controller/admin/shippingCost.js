...
export const getShipping = async (req, res) => {
    try {
        ...
        const results = await new Promise((resolve, reject) => {
            db.query("SELECT * FROM shipping_rate", 
                (err, result) => {
...
export const updateShipping = async (req, res) => {
    try {
        ...
        const {carrierName, serviceType, weightRangeMin, weightRangeMax, price, deliveryDays, packageId} = req.body; // รับข้อมูลฟิลด์ที่ต้องการอัปเดต
