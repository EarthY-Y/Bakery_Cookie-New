...
const searchShowListGuest = ({ name, itemKeys }) => {
  ...
  return (
    <div className="mb-3">
      <input className="form-control me-2 mt-0 d-none d-md-block " style={{ width: "400px" }} type="search" placeholder={name} aria-label="Search" onChange={(e) => setSearchTerm(e.target.value)} />
      ...
      <input className="form-control me-2 mt-0 d-block d-md-none " style={{ width: "300px" }} type="search" placeholder={name} aria-label="Search" onChange={(e) => setSearchTerm(e.target.value)} />
      {filteredProducts ? (
...
export default searchShowListGuest;
