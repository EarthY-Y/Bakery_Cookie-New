...
const API_URL_PICTURE_PRODUCT = import.meta.env.VITE_API_Port_PICTURE_PRODUCT
                ...
                materialProductMyId.map((products, index) => (
                  <div className="col-12 border rounded p-3 mb-3 shadow bg-light" key={index}>
                    <div className="d-flex align-items-center">           
                      ...
                      <img src={API_URL_PICTURE_PRODUCT + products.productpic_name} height={100} width={150} alt="Material" className="img-fluid rounded" />
