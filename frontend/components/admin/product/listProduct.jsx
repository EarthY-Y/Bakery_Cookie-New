  ...
  return (
    <div className="container mt-5">
      <div className="d-flex justify-content-between align-items-center mb-3">
        ...
        <Link to="/product/create" className="btn btn-success d-none d-md-inline-block"><i class="bi bi-plus-circle-fill"></i> เพิ่มสินค้า </Link>
        <Link to="/product/create" className="btn btn-success btn-sm d-md-none"><i class="bi bi-plus-circle-fill"></i> เพิ่มสินค้า </Link>
      </div>
          ...
          <tbody>
            {products.map((products, index) => (
              <tr key={index}>
                ...
                <td><Link to={`view/${products.product_id}`} className="btn btn-info text-light d-grid mx-auto"><i class="bi bi-eye"></i></Link></td>
              ...
              <div className="col-12 border rounded p-3 shadow-sm bg-light" key={index}>
                <div className="d-flex">
                  ...
                  <div className="ms-3 d-flex flex-column justify-content-between w-100">
                    <h6 className="mb-2">{products.product_name}</h6>
                    <div>
